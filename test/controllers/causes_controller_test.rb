...
class CausesControllerTest < ActionController::TestCase
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post :create, cause: { amount_donated: @cause.amount_donated, amount_requested: @cause.amount_requested, content: @cause.content, image_path: @cause.image_path, title: @cause.title }
    end
  ...
  test "should update cause" do
    patch :update, id: @cause, cause: { amount_donated: @cause.amount_donated, amount_requested: @cause.amount_requested, content: @cause.content, image_path: @cause.image_path, title: @cause.title }
    assert_redirected_to cause_path(assigns(:cause))
  end
